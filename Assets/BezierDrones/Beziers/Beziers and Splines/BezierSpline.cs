...
public class BezierSpline : MonoBehaviour {
	...
	private void EnforceMode (int index) {
		...
		if (index <= middleIndex) {
			...
			//enforcedIndex = middleIndex + 1; //added
			if (fixedIndex < 0) {
    ...
    public Vector3 GetVelocity ( float t) {
		...
		//return transform.TransformPoint(Bezier.GetFirstDerivitive(points[i], points[i+1], points[i+2],points[i+3], t)) - transform.position;
	...
	public void AddCurve(float a,float b , float c) {
		Vector3 point = points [points.Length - 1];
		Array.Resize (ref points, points.Length + 3);
		point.x += UnityEngine.Random.Range (1,a);
		point.y += UnityEngine.Random.Range (1,b);
		point.z += UnityEngine.Random.Range (1, c);
		points [points.Length - 3] = point;
		point.x += UnityEngine.Random.Range (1,a);
		point.y += UnityEngine.Random.Range (1,b);
		point.z += UnityEngine.Random.Range (1, c);
